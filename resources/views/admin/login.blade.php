...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="{{asset('login/login')}}" method="post">
      {{csrf_field()}}
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img id="captcha" src="{{captcha_src()}}" onclick="this.src='{{captcha_src()}}&'+Math.random();"> <a id="kanbuq" href="#" onclick="document.getElementById('captcha').src='{{captcha_src()}}&'+Math.random();" >看不清，换一张</a> </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
